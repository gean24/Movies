...
fun FragmentActivity.snackbar(text: String, duration: Int = Toast.LENGTH_SHORT, isSuccess:Boolean = false) {
    val sb = Snackbar.make(
        this.findViewById(android.R.id.content),
        text,
        duration
    )
    sb.view.setBackgroundColor(resources.getColor(if (isSuccess) R.color.blue else R.color.white))
    sb.show()
}
